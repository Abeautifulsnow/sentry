...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'AlertRule', fields ['project', 'name']
        db.delete_unique(u"sentry_alertrule", [u"project_id", "name"])

        # Adding model 'AlertRuleQuerySubscription'
        db.create_table(
        ...
        db.send_create_signal("sentry", ["AlertRuleQuerySubscription"])

        # Adding field 'QuerySubscription.aggregation'
        db.add_column(
        ...
        # Adding field 'AlertRule.organization'
        db.add_column(
            "sentry_alertrule",
            "organization",
            self.gf("sentry.db.models.fields.foreignkey.FlexibleForeignKey")(
        ...
        # Adding field 'AlertRule.aggregation'
        db.add_column(
            "sentry_alertrule",
            "aggregation",
            self.gf("django.db.models.fields.IntegerField")(default=0),
        ...
        # Changing field 'AlertRule.project'
        db.alter_column(
            "sentry_alertrule",
            u"project_id",
            self.gf("sentry.db.models.fields.foreignkey.FlexibleForeignKey")(
        ...
        # Adding unique constraint on 'AlertRule', fields ['organization', 'name']
        db.create_unique("sentry_alertrule", [u"organization_id", "name"])

    def backwards(self, orm):
        # Removing unique constraint on 'AlertRule', fields ['organization', 'name']
        db.delete_unique("sentry_alertrule", [u"organization_id", "name"])

        # Deleting model 'AlertRuleQuerySubscription'
        db.delete_table("sentry_alertrulequerysubscription")

        # Deleting field 'QuerySubscription.aggregation'
        db.delete_column("sentry_querysubscription", "aggregation")

        # Deleting field 'AlertRule.organization'
        db.delete_column("sentry_alertrule", u"organization_id")

        # Deleting field 'AlertRule.aggregation'
        db.delete_column("sentry_alertrule", "aggregation")
        ...
        db.alter_column(
            ...
            u"project_id",
            self.gf("sentry.db.models.fields.foreignkey.FlexibleForeignKey")(
                default=1, to=orm["sentry.Project"]
            ),
        )
        ...
        # Adding unique constraint on 'AlertRule', fields ['project', 'name']
        db.create_unique(u"sentry_alertrule", [u"project_id", "name"])
    ...
    models = {
        ...
        "sentry.apiapplication": {
            ...
            "client_id": (
                ...
                [],
                {
                    "default": "'c7f0a67e8e3c44be9fe1ff51d4b8e081fc4f8ee0803f4d97bffcf9b7ac2ef19e'",
                    "unique": "True",
                    "max_length": "64",
                },
            ),
            "client_secret": (
                ...
                [],
                {"default": "'684bea3cee49417e9dd4e12cbda4918e13e13d46e9f0426c930640bfaadb4d45'"},
            ),
            "date_added": (
                "django.db.models.fields.DateTimeField",
                [],
            ...
            "name": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'Rare Dinosaur'", "max_length": "64", "blank": "True"},
            ),
            "owner": (
                "sentry.db.models.fields.foreignkey.FlexibleForeignKey",
                [],
        ...
        "sentry.apigrant": {
            ...
            "code": (
                ...
                [],
                {
                    "default": "'3b86f2b67deb40929fe7664472b4ec22'",
                    "max_length": "64",
                    "db_index": "True",
                },
            ),
            "expires_at": (
                "django.db.models.fields.DateTimeField",
                [],
                {"default": "datetime.datetime(2019, 8, 28, 0, 0)", "db_index": "True"},
            ),
            "id": (
                "sentry.db.models.fields.bounded.BoundedBigAutoField",
                [],
        ...
        "sentry.apitoken": {
            ...
            "expires_at": (
                "django.db.models.fields.DateTimeField",
                [],
                {"default": "datetime.datetime(2019, 9, 27, 0, 0)", "null": "True"},
            ),
            "id": (
                "sentry.db.models.fields.bounded.BoundedBigAutoField",
                [],
            ...
            "refresh_token": (
                ...
                [],
                {
                    "default": "'ea88ad93b96240f5be6d28df675f0c3452fdb02c403e46349d2b9b6b6dd977fa'",
                    "max_length": "64",
                    "unique": "True",
                    "null": "True",
                },
            ...
            "token": (
                ...
                [],
                {
                    "default": "'2976c2a8a3764d6896c034bc7ac671605d23ee5f742046dab2fd9a161c485c3f'",
                    "unique": "True",
                    "max_length": "64",
                },
            ),
        ...
        "sentry.broadcast": {
            ...
            "date_expires": (
                "django.db.models.fields.DateTimeField",
                [],
                {"default": "datetime.datetime(2019, 9, 4, 0, 0)", "null": "True", "blank": "True"},
            ),
            "id": (
                "sentry.db.models.fields.bounded.BoundedBigAutoField",
                [],
        ...
        "sentry.groupshare": {
            ...
            "uuid": (
                ...
                [],
                {
                    "default": "'c1e3f7b110ef40b9a8edc2b82f5cf915'",
                    "unique": "True",
                    "max_length": "32",
                },
            ),
        ...
        "sentry.scheduleddeletion": {
            ...
            "date_scheduled": (
                "django.db.models.fields.DateTimeField",
                [],
                {"default": "datetime.datetime(2019, 9, 27, 0, 0)"},
            ),
            "guid": (
                "django.db.models.fields.CharField",
                [],
                {
                    "default": "'abe1a51f552a4cf4afc4a84a4376dce6'",
                    "unique": "True",
                    "max_length": "32",
                },
            ),
        ...
        "sentry.sentryapp": {
            ...
            "uuid": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'56b99ed5-76fe-4d35-8ecc-d1fd63819b24'", "max_length": "64"},
            ),
        ...
        "sentry.sentryappinstallation": {
            ...
            "uuid": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'70f1955f-c736-4d73-a609-16157c51a8d4'", "max_length": "64"},
            ),
        },
        ...
        "sentry.servicehook": {
            ...
            "secret": (
                "sentry.db.models.fields.encrypted.EncryptedTextField",
                [],
                {"default": "'13720d83af394c90b92149ab46bdbd5cc69bc59b05ab45ba994fce4eecda3eb3'"},
            ),
            "status": (
                "sentry.db.models.fields.bounded.BoundedPositiveIntegerField",
                [],
        ...
        "sentry.useremail": {
            ...
            "validation_hash": (
                "django.db.models.fields.CharField",
                [],
                {"default": "u'z5RxUZDmUtoJksdvKdZPFhHB3KakiQln'", "max_length": "32"},
            ),
        },
        "sentry.userip": {
            "Meta": {
